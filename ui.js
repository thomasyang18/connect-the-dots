...
export class UI {
    constructor(polygon) {
        ...
        this.proofButton.style.backgroundColor = 'red';
        ...
        this.proofTextArea.style.width = '800px';
        this.proofTextArea.style.height = '800px';
        this.proofTextArea.style.backgroundColor = '#f0f0f0';
        this.proofTextArea.style.borderRadius = '10px';
        this.proofTextArea.style.padding = '20px';
        this.proofTextArea.style.opacity = '0';
        this.proofTextArea.style.transition = 'opacity 0.5s';
        this.proofTextArea.value = 'This is a proof text box. You can write your proof here.';
